...
{
    public partial class ReporteInsumoFaltantes : Form
    {
        ...
        private void CargarReporte()
        {
            ...
            List<ReporteVariables> _lista = _consu.DevolverListaReporteInsumosFaltantes(_mes, _anio);
